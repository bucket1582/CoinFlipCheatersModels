...
print(f"Simple Model Result: {test_model(simple_model, 1000)}")
print(f"Elastic Model Result: {test_model(elastic_model, 1000)}")
print(f"Biased Model Result: {test_model(biased_model, 1000)}")
